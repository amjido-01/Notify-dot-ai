    ...
    <div className="flex flex-col min-h-screen bg-[#000000] text-white overflow-hidden">
      <header className="px-4 lg:px-6 h-16 flex items-center fixed w-full bg-[#000000] bg-opacity-80 backdrop-blur-md z-50">
        ...
        <nav className="hidden md:flex border-2 border-red-500 items-center ml-auto gap-4 sm:gap-6">
          ...
          <Link href="/auth/signup" className='bg-transparent border border-[#50E3C2] text-[#50E3C2] hover:bg-[#50E3C2] hover:text-black transition-all duration-300 h-10 px-4 py-2 inline-flex items-center justify-center whitespace-nowrap rounded-md ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50'>Sign Up</Link>
        </nav>
